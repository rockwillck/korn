...
function registerDict() {
    ...
    for (word of Object.keys(vocabulary)) {
        ...
        <td>${vocabulary[word].filter(function (v, i, self) {return i == self.indexOf(v)}).map(x => "<a href='https://translate.yandex.com/en/?source_lang=en&target_lang=ko&text=" + x + "' target='_blank'>" + x + "</a>").join(" / ")}</td>
      </tr>`
    }
